...
variable "elb_public_cidrs" {
  description = "(Required)  used as an iterator to create multiple resources or attach attributes to resources in the elastic LB subnet for the application layer"
